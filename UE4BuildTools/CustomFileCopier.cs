...
namespace UE4BuildTools
{
    ...
    class CustomFileCopier
    {
        ...
        public void Copy()
        {
            ...
            using (FileStream source = new FileStream(SourceFilePath, FileMode.Open, FileAccess.ReadWrite))
            {
                long fileLength = source.Length;
                using (FileStream dest = new FileStream(DestFilePath, FileMode.CreateNew, FileAccess.ReadWrite))
                {
                    long totalBytes = 0;
